// Generated by kea-typegen on Sat, 04 Mar 2023 08:24:32 GMT. DO NOT EDIT THIS FILE MANUALLY.
...
export interface userTableLogicType extends Logic {
  actionCreators: {
    ...
    filterForUserIds: (whitelistUserIds: string[]) => {
  ...
  actions: {
    ...
    filterForUserIds: (whitelistUserIds: string[]) => void
    setFilter: (filterType: FilterType) => void
  }
  asyncActions: {
    loadUserEvents: (userId: string) => Promise<any>
    filterForUserIds: (whitelistUserIds: string[]) => Promise<any>
  ...
  __keaTypeGenInternalReducerActions: {
    'filter for user ids (src.scenes.eventFunnelLogic)': (whitelistUserIds: string[]) => {
      type: 'filter for user ids (src.scenes.eventFunnelLogic)'
      payload: {
        whitelistUserIds: string[]
      }
